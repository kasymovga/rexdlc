...
baseprepare:
	test -d base-gfx -a -d base-maps -a -d base-maps-lightmaps -a -d base-models -a -d base-sounds -a -d base-textures -a -d base-textures-extra || sh baseprepare

base-gfx base-maps base-maps-lightmaps base-models base-sounds base-textures-extra base-textures: baseprepare
